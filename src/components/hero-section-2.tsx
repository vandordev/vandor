...
import { Linear } from '#/components/ui/svgs/linear.tsx'
import { Figma } from '#/components/ui/svgs/figma.tsx'
import { Vercel } from '#/components/ui/svgs/vercel.tsx'
import { Firebase } from '#/components/ui/svgs/firebase.tsx'
import { ClerkIconLight as Clerk } from '#/components/ui/svgs/clerk.tsx'
                    ...
                    <div className="relative pb-32 pt-44">
                        ...
                        <div className="relative z-10 mx-auto w-full max-w-5xl px-6">
                            ...
                            <div className="mx-auto max-w-md text-center">
                                <h1 className="text-balance text-4xl font-medium sm:text-5xl">Ship faster. Integrate smarter.</h1>
